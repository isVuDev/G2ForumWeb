 ...
 * @author APC
 */
public class SearchHomeUserServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<userDTO> list_user = (List<userDTO>) u_dao.getUsers(searchValue);
            request.setAttribute("ACCS", list_user);
            url = HOME_PAGE;
